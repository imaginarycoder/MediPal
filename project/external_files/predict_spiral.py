...
def openFile_svm():
    with open('C:\\Minor\\Minor_django\\project\\external_files\\model_parkinson_svm_spiral.pkl', 'rb') as file:
        model = pickle.load(file)
        file.close()
    return model

def openFile_naive_bayes():
    with open('C:\\Minor\\Minor_django\\project\\external_files\\model_parkinson_bayes_spiral.pkl', 'rb') as file:
        model = pickle.load(file)
        file.close()
    return model
